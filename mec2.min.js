 ...
 * @license MIT License
 */
"use strict";const mec={VERSION:"0.70",global:this,EPS:1.19209e-7,linTol:.001,angTol:2/180*Math.PI,velTol:.01,forceTol:.1,momentTol:.01,maxLinCorrect:20,asmItrMax:512,itrMax:256,corrMax:64,priority:"velocity",showNodeLabels:false,showConstraintLabels:true,showLoadLabels:true,validConstraintColor:"#777",invalidConstraintColor:"#b11",forceColor:"orange",m_u:.01,to_m(t){return t*mec.m_u},from_m(t){return t/mec.m_u},to_N(t){return t*mec.m_u},from_N(t){return t/mec.m_u},to_Nm(t){return t*mec.m_u*mec.m_u},from_Nm(t){return t/mec.m_u/mec.m_u},to_J(t){return mec.to_Nm(t)},from_J(t){return mec.from_Nm(t)},to_kgm2(t){return t*mec.m_u*mec.m_u},from_kgm(t){return t/mec.m_u/mec.m_u},isEps(t,i){return t<(i||mec.EPS)&&t>-(i||mec.EPS)},clamp(t,i,s){return Math.min(Math.max(t,i),s)},toRad(t){return t*Math.PI/180},toDeg(t){return t/Math.PI*180},mixin(t,...i){i.forEach(i=>{t=Object.defineProperties(t,Object.getOwnPropertyDescriptors(i))});return t}};
/**
 ...
 * @requires g2.js
 */
"use strict";mec.load={extend(t){if(t.type&&mec.load[t.type]){Object.setPrototypeOf(t,mec.load[t.type]);t.constructor()}return t}};mec.load.force={constructor(){},init(t){this.model=t;if(!this.type)this.type="force";if(this.type==="force")this.init_force(t)},init_force(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(typeof this.wref==="string")this.wref=t.constraintById(this.wref);this.value=mec.from_N(this.value||1);this.w0=typeof this.w0==="number"?this.w0:0},dependsOn(t){return this.p===t||this.wref===t},get w(){return this.wref?this.wref.w+this.w0:this.w0},get Qx(){return this.value*Math.cos(this.w)},get Qy(){return this.value*Math.sin(this.w)},reset(){},apply(){if(this.type==="force"&&!this.p.base){this.p.Qx+=mec.from_N(this.Qx);this.p.Qy+=mec.from_N(this.Qy)}},get isSolid(){return false},get sh(){return this.state&g2.OVER?[0,0,4,"gray"]:false},hitContour({x:t,y:i,eps:s}){const e=45,r=this.p,h=Math.cos(this.w),n=Math.sin(this.w),o=2*mec.node.radius;return g2.isPntOnLin({x:t,y:i},{x:r.x+o*h,y:r.y+o*n},{x:r.x+(e+o)*h,y:r.y+(e+o)*n},s)},g2(){if(this.type==="force"){const t=this.w,i=Math.cos(t),s=Math.sin(t),e=this.p,r=mec.load.force.arrowLength,h=2*mec.node.radius,n=this.mode==="push"?-1:1,o=e.x+n*25*i-12*s,a=e.y+n*25*s+12*i,d=this.mode==="push"?()=>e.x-(r+h)*i:()=>e.x+h*i,f=this.mode==="push"?()=>e.y-(r+h)*s:()=>e.y+h*s,p=g2().beg({x:d,y:f,w:t,scl:1,lw:2,ls:mec.forceColor,lc:"round",sh:()=>this.sh,fs:"@ls"}).drw({d:mec.load.force.arrow,lsh:true}).end();if(mec.showLoadLabels)p.txt({str:this.id||"?",x:o,y:a,thal:"center",tval:"middle"});return p}},arrowLength:45,arrow:"M0,0 35,0M45,0 36,-3 37,0 36,3 Z"};
/**
 ...
 * @requires g2.js
 */
"use strict";mec.shape={extend(t){if(t.type&&mec.shape[t.type]){Object.setPrototypeOf(t,Object.assign({},this.prototype,mec.shape[t.type]));t.constructor()}return t},prototype:{constructor(){},dependsOn(t){return false}}};mec.shape.fix={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p)},dependsOn(t){return this.p===t},draw(t){t.use({grp:"nodfix",x:()=>this.p.x,y:()=>this.p.y,w:this.w0||0})}};mec.shape.flt={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p)},dependsOn(t){return this.p===t},draw(t){t.use({grp:"nodflt",x:()=>this.p.x,y:()=>this.p.y,w:this.w0||0})}};mec.shape.slider={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(typeof this.wref==="string")this.wref=t.constraintById(this.wref)},dependsOn(t){return this.p===t||this.wref===t},draw(t){const i=this.wref?()=>this.wref.w:this.w0||0;t.beg({x:()=>this.p.x,y:()=>this.p.y,w:i}).rec({x:-16,y:-10,b:32,h:20,ls:"@nodcolor",fs:"@linkfill",lw:1,lj:"round"}).end()}};mec.shape.bar={init(t){if(typeof this.p1==="string"&&typeof this.p2==="string"){this.p1=t.nodeById(this.p1);this.p2=t.nodeById(this.p2)}},dependsOn(t){return this.p1===t||this.p2===t},draw(t){const i=()=>this.p1.x,s=()=>this.p1.y,e=()=>this.p2.x,r=()=>this.p2.y;t.lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill",lw:3,lc:"round"})}};mec.shape.beam={init(t){if(typeof this.wref==="string"&&this.len>0){this.p=t.nodeById(this.p);this.wref=t.constraintById(this.wref)}},dependsOn(t){return this.p===t||this.wref===t},draw(t){const i=()=>this.p.x,s=()=>this.p.y,e=()=>this.p.x+this.len*Math.cos(this.wref.w),r=()=>this.p.y+this.len*Math.sin(this.wref.w);t.lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill",lw:3,lc:"round"})}};mec.shape.wheel={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(typeof this.wref==="string")this.wref=t.constraintById(this.wref)},dependsOn(t){return this.p===t||this.wref===t},draw(t){const i=this.wref?()=>this.wref.w:this.w0||0,s=this.r,e=Math.sin(2*Math.PI/3),r=Math.cos(2*Math.PI/3);t.beg({x:()=>this.p.x,y:()=>this.p.y,w:i}).lin({x1:0,y1:0,x2:s-4,y2:0,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:s-4,y2:0,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:s-4,y2:0,ls:"@nodfill",lw:3,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:(s-4)*e,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:(s-4)*e,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:(s-4)*e,ls:"@nodfill",lw:3,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:-(s-4)*e,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:-(s-4)*e,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:-(s-4)*e,ls:"@nodfill",lw:3,lc:"round"}).cir({x:0,y:0,r:s-2.5,ls:"#e6e6e6",fs:"transparent",lw:5}).cir({x:0,y:0,r:s,ls:"@nodcolor",fs:"transparent",lw:1}).cir({x:0,y:0,r:s-5,ls:"@nodcolor",fs:"transparent",lw:1}).end()}};mec.shape.img={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(typeof this.wref==="string")this.wref=t.constraintById(this.wref)},dependsOn(t){return this.p===t||this.wref===t},draw(t){const i=this.w0||0,s=this.wref?()=>this.wref.w+i:i;t.img({uri:this.uri,x:()=>this.p.x,y:()=>this.p.y,w:s,scl:this.scl,xoff:this.xoff,yoff:this.yoff})}};
/**
 ...
 */
"use strict";mec.model={extend(t){Object.setPrototypeOf(t,this.prototype);t.constructor();return t},prototype:{constructor(){this.state={dirty:true,valid:true,direc:1,itrpos:0,itrvel:0};this.timer={t:0,dt:1/60}},init(){if(!this.nodes)this.nodes=[];for(const t of this.nodes)mec.node.extend(t).init(this);if(!this.constraints)this.constraints=[];for(const t of this.constraints)if(!t.initialized)mec.constraint.extend(t).init(this);if(!this.loads)this.loads=[];for(const t of this.loads)mec.load.extend(t).init(this);if(!this.shapes)this.shapes=[];for(const t of this.shapes)mec.shape.extend(t).init(this);if(this.gravity===true)this.gravity={x:0,y:-10};return this},reset(){this.timer.t=0;for(const t of this.nodes)t.reset();for(const t of this.constraints)t.reset();for(const t of this.loads)t.reset();return this},asm(){let t=this.asmPos();t=this.asmVel()&&t;return this},pose(){return this.asmPos()},tick(t){if(t)this.timer.t+=this.timer.dt=t;this.pre().itr().post();return this},stop(){for(const t of this.nodes)t.xt=t.yt=t.xtt=t.ytt=0;return this},get dof(){let t=0;for(const i of this.nodes)t+=i.dof;for(const i of this.constraints)t-=2-i.dof;return t},get hasGravity(){return this.gravity===true||this.gravity&&(this.gravity.x!==0||this.gravity.y!==0)},get dirty(){return this.state.dirty},set dirty(t){this.state.dirty=t},get valid(){return this.state.valid},set valid(t){this.state.valid=t},get itrpos(){return this.state.itrpos},set itrpos(t){this.state.itrpos=t},get itrvel(){return this.state.itrvel},set itrvel(t){this.state.itrvel=t},get direc(){return this.state.direc},set direc(t){this.state.direc=t},get isActive(){return!this.hasActiveDrives&&this.isSleeping},get isSleeping(){let t=true;for(const i of this.nodes)if(t&&!i.isSleeping)t=false;return t},get hasActiveDrives(){let t=false;for(const i of this.constraints)t=i.ori.type==="drive"&&this.timer.t<i.ori.t0+i.ori.Dt||i.len.type==="drive"&&this.timer.t<i.len.t0+i.len.Dt;return t},hasDependencies(t){let i=false;for(const s of this.constraints)i=s.dependsOn(t)||i;for(const s of this.loads)i=s.dependsOn(t)||i;for(const s of this.shapes)i=s.dependsOn(t)||i;return i},addNode(t){this.nodes.push(t)},nodeById(t){for(const i of this.nodes)if(i.id===t)return i;return false},removeNode(t){const i=this.nodes.indexOf(t),s=this.nodes.includes(t)&&this.hasDependencies(t);if(!s)this.nodes.splice(i,1);return!s},purgeNode(t){for(const i of this.constraints)if(i.dependsOn(t))this.purgeConstraint(i);for(const i of this.loads)if(i.dependsOn(t))this.purgeLoad(i);for(const i of this.shapes)if(i.dependsOn(t))this.purgeShape(i);this.nodes.splice(this.nodes.indexOf(t),1)},addConstraint(t){this.constraints.push(t)},constraintById(t){for(const i of this.constraints)if(i.id===t)return i;return false},removeConstraint(t){const i=this.constraints.indexOf(t),s=i>=0&&this.hasDependencies(t);if(!s)this.constraints.splice(i,1);return!s},purgeConstraint(t){for(const i of this.loads)if(i.dependsOn(t))this.purgeLoad(i);for(const i of this.shapes)if(i.dependsOn(t))this.purgeShape(i);this.constraints.splice(this.constraints.indexOf(t),1)},addLoad(t){this.loads.push(t)},loadById(t){for(const i of this.nodes)if(i.id===t)return i;return false},removeLoad(t){const i=this.loads.indexOf(t),s=i>=0&&this.hasDependencies(t);if(!s)this.loads.splice(i,1);return!s},purgeLoad(t){this.loads.splice(this.loads.indexOf(t),1)},addShape(t){this.shapes.push(t)},removeShape(t){const i=this.shapes.indexOf(t);if(i>=0)this.shapes.splice(i,1);return true},purgeShape(t){this.loads.splice(this.shapes.indexOf(t),1)},applyLoads(){for(const t of this.nodes){if(!t.base){t.Qx=t.Qy=0;if(this.hasGravity){t.Qx=t.m*mec.from_N(this.gravity.x);t.Qy=t.m*mec.from_N(this.gravity.y)}}}for(const t of this.loads)t.apply();return this},asmPos(){let t=false;this.itrpos=0;while(!t&&this.itrpos++<mec.asmItrMax){t=this.posStep()}return this.valid=t},posStep(){let t=true;for(const i of this.constraints)t=i.posStep()&&t;return t},asmVel(){let t=false;this.itrvel=0;while(!t&&this.itrvel++<mec.asmItrMax)t=this.velStep();return t},velStep(){let t=true;for(const i of this.constraints){t=i.velStep(this.timer.dt)&&t}return t},pre(){this.applyLoads();for(const t of this.nodes)t.pre(this.timer.dt);for(const t of this.constraints)t.pre(this.timer.dt);this.asmPos(this.timer.dt);return this},itr(){this.asmVel();return this},post(){for(const t of this.nodes)t.post(this.timer.dt);for(const t of this.constraints)t.post(this.timer.dt);return this},draw(t){for(const i of this.shapes)i.draw(t);for(const i of this.loads)t.ins(i);for(const i of this.constraints)t.ins(i);for(const i of this.nodes)t.ins(i);return this}}};