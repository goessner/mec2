 ...
 * @requires g2.js
 */
"use strict";mec.shape={extend(t){if(t.type&&mec.shape[t.type]){const i=Object.assign({},this.prototype,mec.shape[t.type]);Object.setPrototypeOf(t,i);t.constructor()}return t},prototype:{remove(){const t=this.model.shapes;return this.model.hasDependents(this)?false:!!t.splice(t.indexOf(this),1)},purge(){this.model.purgeElements(this.model.dependentsOf(this));return this.remove()}}};mec.shape.fix={validate(t){if(this.p===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"shape",id:this.id,idx:t,reftype:"node",name:"p"};if(!this.model.nodes.find(t=>t.id===this.p))return{mid:"E_ELEM_INVALID_REF",elemtype:"shape",id:this.id,idx:t,reftype:"node",name:this.p};else this.p=this.model.nodes.find(t=>t.id===this.p);return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.w0=this.w0||0},dependsOn(t){return this.p===t},asJSON(){return'{ "type":"'+this.type+'","p":"'+this.p.id+'"'+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+" }"},draw(t){t.nodfix({x:()=>this.p.x,y:()=>this.p.y,w:this.w0||0})}};mec.shape.flt={validate(t){if(this.p===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"shape",id:this.id,idx:t,reftype:"node",name:"p"};if(!this.model.nodes.find(t=>t.id===this.p))return{mid:"E_ELEM_INVALID_REF",elemtype:"shape",id:this.id,idx:t,reftype:"node",name:this.p};else this.p=this.model.nodes.find(t=>t.id===this.p);return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.w0=this.w0||0},dependsOn(t){return this.p===t},asJSON(){return'{ "type":"'+this.type+'","p":"'+this.p.id+'"'+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+" }"},draw(t){t.nodflt({x:()=>this.p.x,y:()=>this.p.y,w:this.w0||0})}};mec.shape.slider={validate(t){if(this.p===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"slider",id:this.id,idx:t,reftype:"node",name:"p"};if(!this.model.nodes.find(t=>t.id===this.p))return{mid:"E_ELEM_INVALID_REF",elemtype:"slider",id:this.id,idx:t,reftype:"node",name:this.p};else this.p=this.model.nodes.find(t=>t.id===this.p);if(this.wref&&!this.model.constraints.find(t=>t.id===this.wref))return{mid:"E_ELEM_INVALID_REF",elemtype:"slider",id:this.id,idx:t,reftype:"constraint",name:this.wref};else this.wref=this.model.constraints.find(t=>t.id===this.wref);return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.w0=this.w0||0},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","p":"'+this.p.id+'"'+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+(this.wref?',"wref":"'+this.wref.id+'"':"")+" }"},draw(t){const i=this.wref?()=>this.wref.w:this.w0||0;t.beg({x:()=>this.p.x,y:()=>this.p.y,w:i}).rec({x:-16,y:-10,b:32,h:20,ls:"@nodcolor",fs:"@linkfill",lw:1,lj:"round"}).end()}};mec.shape.bar={validate(t){if(this.p1===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"bar",id:this.id,idx:t,reftype:"node",name:"p1"};if(!this.model.nodes.find(t=>t.id===this.p1))return{mid:"E_ELEM_INVALID_REF",elemtype:"bar",id:this.id,idx:t,reftype:"node",name:this.p1};else this.p1=this.model.nodes.find(t=>t.id===this.p1);if(this.p2===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"bar",id:this.id,idx:t,reftype:"node",name:"p2"};if(!this.model.nodes.find(t=>t.id===this.p2))return{mid:"E_ELEM_INVALID_REF",elemtype:"bar",id:this.id,idx:t,reftype:"node",name:this.p2};else this.p2=this.model.nodes.find(t=>t.id===this.p2);return false},init(t,i){this.model=t;this.model.notifyValid(this.validate(i))},dependsOn(t){return this.p1===t||this.p2===t},asJSON(){return'{ "type":"'+this.type+'","p1":"'+this.p1.id+'","p2":"'+this.p2.id+'" }'},draw(t){const i=()=>this.p1.x,e=()=>this.p1.y,s=()=>this.p2.x,r=()=>this.p2.y;t.lin({x1:i,y1:e,x2:s,y2:r,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:i,y1:e,x2:s,y2:r,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:i,y1:e,x2:s,y2:r,ls:"@nodfill",lw:3,lc:"round"})}};mec.shape.beam={validate(t){if(this.p===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"beam",id:this.id,idx:t,reftype:"node",name:"p"};if(!this.model.nodes.find(t=>t.id===this.p))return{mid:"E_ELEM_INVALID_REF",elemtype:"beam",id:this.id,idx:t,reftype:"node",name:this.p};else this.p=this.model.nodes.find(t=>t.id===this.p);if(this.wref===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"beam",id:this.id,idx:t,reftype:"constraint",name:"wref"};if(!this.model.constraints.find(t=>t.id===this.wref))return{mid:"E_ELEM_INVALID_REF",elemtype:"beam",id:this.id,idx:t,reftype:"constraint",name:this.wref};else this.wref=this.model.constraints.find(t=>t.id===this.wref);return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.len=this.len||100},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","p":"'+this.p.id+'","wref":"'+this.wref.id+'","len":"'+this.len+'" }'},draw(t){const i=()=>this.p.x,e=()=>this.p.y,s=()=>this.p.x+this.len*Math.cos(this.wref.w),r=()=>this.p.y+this.len*Math.sin(this.wref.w);t.lin({x1:i,y1:e,x2:s,y2:r,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:i,y1:e,x2:s,y2:r,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:i,y1:e,x2:s,y2:r,ls:"@nodfill",lw:3,lc:"round"})}};mec.shape.wheel={validate(t){if(this.p===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"wheel",id:this.id,idx:t,reftype:"node",name:"p"};if(!this.model.nodes.find(t=>t.id===this.p))return{mid:"E_ELEM_INVALID_REF",elemtype:"wheel",id:this.id,idx:t,reftype:"node",name:this.p};else this.p=this.model.nodes.find(t=>t.id===this.p);if(this.wref===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"wheel",id:this.id,idx:t,reftype:"constraint",name:"wref"};if(!this.model.constraints.find(t=>t.id===this.wref))return{mid:"E_ELEM_INVALID_REF",elemtype:"wheel",id:this.id,idx:t,reftype:"constraint",name:this.wref};else this.wref=this.model.constraints.find(t=>t.id===this.wref);return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.w0=this.w0||0;this.r=this.r||20},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","p":"'+this.p.id+'","r":'+this.r+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+(this.wref?',"wref":"'+this.wref.id+'"':"")+" }"},draw(t){const i=this.wref?()=>this.wref.w:this.w0||0,e=this.r,s=Math.sin(2*Math.PI/3),r=Math.cos(2*Math.PI/3);t.beg({x:()=>this.p.x,y:()=>this.p.y,w:i}).lin({x1:0,y1:0,x2:e-4,y2:0,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:e-4,y2:0,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:e-4,y2:0,ls:"@nodfill",lw:3,lc:"round"}).lin({x1:0,y1:0,x2:(e-4)*r,y2:(e-4)*s,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:(e-4)*r,y2:(e-4)*s,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:(e-4)*r,y2:(e-4)*s,ls:"@nodfill",lw:3,lc:"round"}).lin({x1:0,y1:0,x2:(e-4)*r,y2:-(e-4)*s,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:(e-4)*r,y2:-(e-4)*s,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:(e-4)*r,y2:-(e-4)*s,ls:"@nodfill",lw:3,lc:"round"}).cir({x:0,y:0,r:e-2.5,ls:"#e6e6e6",fs:"transparent",lw:5}).cir({x:0,y:0,r:e,ls:"@nodcolor",fs:"transparent",lw:1}).cir({x:0,y:0,r:e-5,ls:"@nodcolor",fs:"transparent",lw:1}).end()}};mec.shape.poly={validate(t){if(this.pts===undefined)return{mid:"E_POLY_PTS_MISSING",id:this.id,idx:t};if(this.pts.length<2)return{mid:"E_POLY_PTS_INVALID",id:this.id,idx:t};if(this.p===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"polygon",id:this.id,idx:t,reftype:"node",name:"p"};if(!this.model.nodes.find(t=>t.id===this.p))return{mid:"E_ELEM_INVALID_REF",elemtype:"polygon",id:this.id,idx:t,reftype:"node",name:this.p};else this.p=this.model.nodes.find(t=>t.id===this.p);if(this.wref===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"polygon",id:this.id,idx:t,reftype:"constraint",name:"wref"};if(!this.model.constraints.find(t=>t.id===this.wref))return{mid:"E_ELEM_INVALID_REF",elemtype:"polygon",id:this.id,idx:t,reftype:"constraint",name:this.wref};else this.wref=this.model.constraints.find(t=>t.id===this.wref);return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.fill=this.fill||"#aaaaaa88";this.stroke=this.stroke||"transparent"},get x0(){return this.p.x0},get y0(){return this.p.y0},get w0(){return this.wref.w0},get w(){return this.wref.w-this.wref.w0},get x(){const t=this.wref.w-this.wref.w0;return this.p.x-Math.cos(t)*this.p.x0+Math.sin(t)*this.p.y0},get y(){const t=this.wref.w-this.wref.w0;return this.p.y-Math.sin(t)*this.p.x0-Math.cos(t)*this.p.y0},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","pts":'+JSON.stringify(this.pts)+',"p":"'+this.p.id+'"'+(this.wref?',"wref":"'+this.wref.id+'"':"")+(this.w0&&this.w0>1e-4&&!(this.wref.w0===this.w0)?',"w0":'+this.w0:"")+(this.stroke&&!(this.stroke==="transparent")?',"stroke":"'+this.stroke+'"':"")+(this.fill&&!(this.fill==="#aaaaaa88")?',"fill":"'+this.fill+'"':"")+" }"},draw(t){t.ply({pts:this.pts,closed:true,x:()=>this.x,y:()=>this.y,w:()=>this.w,fs:this.fill,ls:this.stroke})}};mec.shape.img={validate(t){if(this.uri===undefined)return{mid:"E_IMG_URI_MISSING",id:this.id,idx:t};if(this.p===undefined)return{mid:"E_ELEM_REF_MISSING",elemtype:"image",id:this.id,idx:t,reftype:"node",name:"p"};if(!this.model.nodes.find(t=>t.id===this.p))return{mid:"E_ELEM_INVALID_REF",elemtype:"image",id:this.id,idx:t,reftype:"node",name:this.p};else this.p=this.model.nodes.find(t=>t.id===this.p);if(this.wref&&!this.model.constraints.find(t=>t.id===this.wref))return{mid:"E_ELEM_INVALID_REF",elemtype:"image",id:this.id,idx:t,reftype:"constraint",name:this.wref};else this.wref=this.model.constraints.find(t=>t.id===this.wref);return false},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;this.w0=this.w0||0;this.xoff=this.xoff||0;this.yoff=this.yoff||0;this.scl=this.scl||1},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","uri":"'+this.uri+'","p":"'+this.p.id+'"'+(this.wref?',"wref":"'+this.wref.id+'"':"")+(this.w0&&Math.abs(this.w0)>1e-4?',"w0":'+this.w0:"")+(this.xoff&&Math.abs(this.xoff)>1e-4?',"xoff":'+this.xoff:"")+(this.yoff&&Math.abs(this.yoff)>1e-4?',"yoff":'+this.yoff:"")+(this.scl&&Math.abs(this.scl-1)>1e-4?',"scl":'+this.scl:"")+" }"},draw(t){const i=this.w0||0,e=this.wref?()=>this.wref.w+i:i;t.img({uri:this.uri,x:()=>this.p.x,y:()=>this.p.y,w:e,scl:this.scl,xoff:this.xoff,yoff:this.yoff})}};mec.model.prototype.addPlugIn("shapes",mec.shape);
/**
