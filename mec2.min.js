 ...
 * @license MIT License
 */
"use strict";const mec={EPS:1.19209e-7,linTol:.001,angTol:2/180*Math.PI,velTol:.01,forceTol:.1,momentTol:.01,maxLinCorrect:20,asmItrMax:512,itrMax:256,corrMax:64,priority:"velocity",showNodeLabels:false,showConstraintLabels:true,showLoadLabels:true,darkmode:false,get validConstraintColor(){return this.darkmode?"#ffffff99":"#777"},invalidConstraintColor:"#b11",get forceColor(){return this.darkmode?"crimson":"orange"},get springColor(){return this.darkmode?"lightslategray":"@linkcolor"},get constraintVectorColor(){return this.darkmode?"orange":"green"},get hoveredElmColor(){return this.darkmode?"white":"gray"},get selectedElmColor(){return this.darkmode?"yellow":"blue"},get txtColor(){return this.darkmode?"white":"black"},get velColor(){return this.darkmode?"lightblue":"mediumblue"},get accColor(){return this.darkmode?"wheat":"saddlebrown"},gravity:{x:0,y:-10,active:false},m_u:.01,to_m(t){return t*mec.m_u},from_m(t){return t/mec.m_u},to_N(t){return t*mec.m_u},from_N(t){return t/mec.m_u},to_Nm(t){return t*mec.m_u*mec.m_u},from_Nm(t){return t/mec.m_u/mec.m_u},to_N_m(t){return t},from_N_m(t){return t},to_J(t){return mec.to_Nm(t)},from_J(t){return mec.from_Nm(t)},to_kgm2(t){return t*mec.m_u*mec.m_u},from_kgm2(t){return t/mec.m_u/mec.m_u},velScale:1/4,accScale:1/10,isEps(t,i){return t<(i||mec.EPS)&&t>-(i||mec.EPS)},toZero(t,i){return t<(i||mec.EPS)&&t>-(i||mec.EPS)?0:t},clamp(t,i,s){return Math.min(Math.max(t,i),s)},asympClamp(t,i,s){const e=.5*(s-i);return e?i+.5*e+Math.tanh(((Math.min(Math.max(t,i),s)-i)/e-.5)*5)*.5*e:i},toRad(t){return t*Math.PI/180},toDeg(t){return t/Math.PI*180},mixin(t,...i){i.forEach(i=>{t=Object.defineProperties(t,Object.getOwnPropertyDescriptors(i))});return t}};
/**
 ...
 * @requires g2.js
 */
"use strict";mec.view={extend(t){if(t.type&&mec.view[t.type]){Object.setPrototypeOf(t,mec.view[t.type]);t.constructor()}return t}};mec.view.vector={constructor(){},init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(this.value&&this.p[this.value]);},dependsOn(t){return this.p===t},draw(t){t.vec({x1:()=>this.p.x,y1:()=>this.p.y,x2:()=>this.p.x+this.p[this.value]().x,y2:()=>this.p.y+this.p[this.value]().y,ls:mec.velColor,lw:1.5})}};
/**
 * mec.shape (c) 2018 Stefan Goessner
 * @license MIT License
 * @requires mec.core.js
