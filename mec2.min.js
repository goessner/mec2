 ...
 * @license MIT License
 */
"use strict";const mec={EPS:1.19209e-7,linTol:.001,angTol:2/180*Math.PI,velTol:.01,forceTol:.1,momentTol:.01,maxLinCorrect:20,asmItrMax:512,itrMax:256,corrMax:64,showNodeLabels:false,showConstraintLabels:true,showLoadLabels:true,darkmode:false,get validConstraintColor(){return this.darkmode?"#ffffff99":"#777"},invalidConstraintColor:"#b11",get forceColor(){return this.darkmode?"crimson":"orange"},get springColor(){return this.darkmode?"lightslategray":"@linkcolor"},get constraintVectorColor(){return this.darkmode?"orange":"green"},get hoveredElmColor(){return this.darkmode?"white":"gray"},get selectedElmColor(){return this.darkmode?"yellow":"blue"},get txtColor(){return this.darkmode?"white":"black"},color:{get vel(){return mec.darkmode?"lightsteelblue":"steelblue"},get acc(){return mec.darkmode?"lightsalmon":"firebrick"},get force(){return mec.darkmode?"wheat":"saddlebrown"}},gravity:{x:0,y:-10,active:false},aly:{mass:{get scl(){return 1},type:"num",name:"m",unit:"kg"},vel:{get scl(){return mec.m_u},type:"vec",name:"v",unit:"m/s",get drwscl(){return 40*mec.m_u}},acc:{get scl(){return mec.m_u},type:"vec",name:"a",unit:"m/s^2",get drwscl(){return 10*mec.m_u}},w:{get scl(){return 180/Math.PI},type:"num",name:"φ",unit:"°"},wt:{get scl(){return 1},type:"num",name:"ω",unit:"rad/s"},wtt:{get scl(){return 1},type:"num",name:"α",unit:"rad/s^2"},force:{get scl(){return mec.m_u},type:"vec",name:"F",unit:"N",get drwscl(){return 5*mec.m_u}},velAbs:{get scl(){return mec.m_u},type:"num",name:"v",unit:"m/s"},accAbs:{get scl(){return mec.m_u},type:"num",name:"a",unit:"m/s"},forceAbs:{get scl(){return mec.m_u},type:"num",name:"F",unit:"N"},moment:{get scl(){return mec.m_u**2},type:"num",name:"M",unit:"Nm"}},m_u:.01,to_m(t){return t*mec.m_u},from_m(t){return t/mec.m_u},to_N(t){return t*mec.m_u},from_N(t){return t/mec.m_u},to_Nm(t){return t*mec.m_u*mec.m_u},from_Nm(t){return t/mec.m_u/mec.m_u},to_N_m(t){return t},from_N_m(t){return t},to_J(t){return mec.to_Nm(t)},from_J(t){return mec.from_Nm(t)},to_kgm2(t){return t*mec.m_u*mec.m_u},from_kgm2(t){return t/mec.m_u/mec.m_u},isEps(t,i){return t<(i||mec.EPS)&&t>-(i||mec.EPS)},toZero(t,i){return t<(i||mec.EPS)&&t>-(i||mec.EPS)?0:t},clamp(t,i,s){return Math.min(Math.max(t,i),s)},asympClamp(t,i,s){const e=s-i;return e?i+.5*e+Math.tanh(((Math.min(Math.max(t,i),s)-i)/e-.5)*5)*.5*e:i},toRad(t){return t*Math.PI/180},toDeg(t){return t/Math.PI*180},mixin(t,...i){i.forEach(i=>{t=Object.defineProperties(t,Object.getOwnPropertyDescriptors(i))});return t}};
/**
 ...
 * @requires g2.js
 */
"use strict";mec.view={extend(t){if(t.type&&mec.view[t.type]){Object.setPrototypeOf(t,mec.view[t.type]);t.constructor()}return t}};mec.view.vector={constructor(){},init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p)},dependsOn(t){return this.p===t},reset(){},asJSON(){return'{ "type":"'+this.type+'","id":"'+this.id+'","p":"'+this.p.id+'"'+(this.value?',"value":'+this.value:"")+" }"},get isSolid(){return false},get sh(){return this.state&g2.OVER?[0,0,10,mec.hoveredElmColor]:false},get endPoints(){const t=mec.aly[this.value].drwscl;const i=this.p[this.value];const s=Math.hypot(i.y,i.x);const e=!mec.isEps(s)?mec.asympClamp(t*s,25,150):0;return{p1:this.p,p2:{x:this.p.x+i.x/s*e,y:this.p.y+i.y/s*e}}},hitContour({x:t,y:i,eps:s}){const e=this.endPoints;return g2.isPntOnLin({x:t,y:i},e.p1,e.p2,s)},g2(){const t=this.endPoints;return g2().vec({x1:t.p1.x,y1:t.p1.y,x2:t.p2.x,y2:t.p2.y,ls:mec.color[this.value],lw:1.5,sh:this.sh})}};mec.view.trace={constructor(){},init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);this.pts=[];this.t0=0;this.model=t},dependsOn(t){return this.p===t},reset(){this.pts.length=0;this.t0=0},post(t){this.pts.push({x:this.p.x,y:this.p.y});if(this.model.timer.t-this.t0>this.Dt)this.pts.shift()},get isSolid(){return false},get sh(){return this.state&g2.OVER?[0,0,10,mec.hoveredElmColor]:false},hitContour({x:t,y:i,eps:s}){return false},g2(){return g2().ply({pts:this.pts,format:"{x,y}",ls:"navy",lw:1.5,fs:this.fill||"transparent",sh:this.sh})}};mec.view.info={constructor(){},init(t){if(typeof this.elem==="string")this.elem=t.elementById(this.elem)},dependsOn(t){return this.elem===t},reset(){},get hasInfo(){return this.elem.state===g2.OVER},infoString(){if(this.value in this.elem){const t=this.elem[this.value];const i=mec.aly[this.value];const s=i.type;const e=t=>(t*i.scl).toPrecision(3);return(this.name||i.name||this.value)+": "+(s==="vec"?"{x:"+e(t.x)+",y:"+e(t.x)+"}":e(t))+" "+i.unit}return"?"}};
/**
 * mec.shape (c) 2018 Stefan Goessner
 * @license MIT License
 * @requires mec.core.js
 ...
 * @requires g2.js
 */
"use strict";mec.shape={extend(t){if(t.type&&mec.shape[t.type]){Object.setPrototypeOf(t,Object.assign({},this.prototype,mec.shape[t.type]));t.constructor()}return t},prototype:{constructor(){},dependsOn(t){return false}}};mec.shape.fix={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p)},dependsOn(t){return this.p===t},asJSON(){return'{ "type":"'+this.type+'","p":'+this.p.id+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+" }"},toJSON(){const t={type:this.type,p:this.p.id};if(this.w0&&this.w0>1e-4)t.w0=this.w0;return t},draw(t){t.use({grp:"nodfix",x:()=>this.p.x,y:()=>this.p.y,w:this.w0||0})}};mec.shape.flt={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p)},dependsOn(t){return this.p===t},asJSON(){return'{ "type":"'+this.type+'","p":'+this.p.id+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+" }"},toJSON(){const t={type:this.type,p:this.p.id};if(this.w0&&this.w0>1e-4)t.w0=this.w0;return t},draw(t){t.use({grp:"nodflt",x:()=>this.p.x,y:()=>this.p.y,w:this.w0||0})}};mec.shape.slider={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(typeof this.wref==="string")this.wref=t.constraintById(this.wref)},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","p":'+this.p.id+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+(this.wref?',"wref":'+this.wref.id:"")+" }"},toJSON(){const t={type:this.type,p:this.p.id};if(this.w0&&this.w0>1e-4)t.w0=this.w0;if(this.wref)t.wref=this.wref.id;return t},draw(t){const i=this.wref?()=>this.wref.w:this.w0||0;t.beg({x:()=>this.p.x,y:()=>this.p.y,w:i}).rec({x:-16,y:-10,b:32,h:20,ls:"@nodcolor",fs:"@linkfill",lw:1,lj:"round"}).end()}};mec.shape.bar={init(t){if(typeof this.p1==="string"&&typeof this.p2==="string"){this.p1=t.nodeById(this.p1);this.p2=t.nodeById(this.p2)}},dependsOn(t){return this.p1===t||this.p2===t},asJSON(){return'{ "type":"'+this.type+'","p1":"'+this.p1.id+'","p2":"'+this.p2.id+'" }'},toJSON(){const t={type:this.type,p1:this.p1.id,p2:this.p2.id};return t},draw(t){const i=()=>this.p1.x,s=()=>this.p1.y,e=()=>this.p2.x,r=()=>this.p2.y;t.lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill",lw:3,lc:"round"})}};mec.shape.beam={init(t){if(typeof this.wref==="string"&&this.len>0){this.p=t.nodeById(this.p);this.wref=t.constraintById(this.wref)}else{console.log("invalid definition of beam shape in model")}},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","p":"'+this.p.id+'","wref":"'+this.wref.id+'","len":"'+this.len+'" }'},toJSON(){const t={type:this.type,p:this.p.id,wref:this.wref.id,len:this.len};return t},draw(t){const i=()=>this.p.x,s=()=>this.p.y,e=()=>this.p.x+this.len*Math.cos(this.wref.w),r=()=>this.p.y+this.len*Math.sin(this.wref.w);t.lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:i,y1:s,x2:e,y2:r,ls:"@nodfill",lw:3,lc:"round"})}};mec.shape.wheel={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(typeof this.wref==="string")this.wref=t.constraintById(this.wref)},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","p":"'+this.p.id+'","w0":'+this.w0+',"r":'+this.r+(this.wref?',"wref":"'+this.wref.id+'"':"")+" }"},toJSON(){const t={type:this.type,p:this.p.id,w0:this.w0,r:this.r};if(this.wref)t.wref=this.wref.id;return t},draw(t){const i=this.wref?()=>this.wref.w:this.w0||0,s=this.r,e=Math.sin(2*Math.PI/3),r=Math.cos(2*Math.PI/3);t.beg({x:()=>this.p.x,y:()=>this.p.y,w:i}).lin({x1:0,y1:0,x2:s-4,y2:0,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:s-4,y2:0,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:s-4,y2:0,ls:"@nodfill",lw:3,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:(s-4)*e,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:(s-4)*e,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:(s-4)*e,ls:"@nodfill",lw:3,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:-(s-4)*e,ls:"@nodcolor",lw:8,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:-(s-4)*e,ls:"@nodfill2",lw:5.5,lc:"round"}).lin({x1:0,y1:0,x2:(s-4)*r,y2:-(s-4)*e,ls:"@nodfill",lw:3,lc:"round"}).cir({x:0,y:0,r:s-2.5,ls:"#e6e6e6",fs:"transparent",lw:5}).cir({x:0,y:0,r:s,ls:"@nodcolor",fs:"transparent",lw:1}).cir({x:0,y:0,r:s-5,ls:"@nodcolor",fs:"transparent",lw:1}).end()}};mec.shape.img={init(t){if(typeof this.p==="string")this.p=t.nodeById(this.p);if(typeof this.wref==="string")this.wref=t.constraintById(this.wref)},dependsOn(t){return this.p===t||this.wref===t},asJSON(){return'{ "type":"'+this.type+'","uri":"'+this.uri+'","p":'+this.p.id+'"'+(this.wref?',"wref":'+this.wref.id:"")+(this.w0&&this.w0>1e-4?',"w0":'+this.w0:"")+(this.xoff&&Math.abs(this.xoff)>1e-4?',"xoff":'+this.xoff:"")+(this.yoff&&Math.abs(this.yoff)>1e-4?',"yoff":'+this.yoff:"")+(this.scl&&Math.abs(this.scl-1)>1e-4?',"scl":'+this.scl:"")+" }"},toJSON(){const t={type:this.type,uri:this.uri,p:this.p.id};if(this.wref)t.wref=this.wref.id;if(this.w0&&this.w0>1e-4)t.w0=this.w0;if(this.xoff&&Math.abs(this.xoff)>1e-4)t.xoff=this.xoff;if(this.yoff&&Math.abs(this.yoff)>1e-4)t.yoff=this.yoff;if(this.scl&&Math.abs(this.scl-1)>1e-4)t.scl=this.scl;return t},draw(t){const i=this.w0||0,s=this.wref?()=>this.wref.w+i:i;t.img({uri:this.uri,x:()=>this.p.x,y:()=>this.p.y,w:s,scl:this.scl,xoff:this.xoff,yoff:this.yoff})}};
/**
