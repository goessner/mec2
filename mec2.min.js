 ...
 * @requires g2.js
 */
"use strict";mec.constraint={extend(t){Object.setPrototypeOf(t,this.prototype);t.constructor();return t},prototype:{constructor(){},validate(t){let i,s=false;if(!this.id)return{mid:"E_ELEM_ID_MISSING",elemtype:"constraint",idx:t};if(this.model.elementById(this.id)!==this)return{mid:"E_ELEM_ID_AMBIGIOUS",id:this.id};if(!this.p1)return{mid:"E_CSTR_NODE_MISSING",id:this.id,loc:"start",p:"p1"};if(!this.p2)return{mid:"E_CSTR_NODE_MISSING",id:this.id,loc:"end",p:"p2"};if(typeof this.p1==="string"){if(!(i=this.model.nodeById(this.p1)))return{mid:"E_CSTR_NODE_NOT_EXISTS",id:this.id,loc:"start",p:"p1",nodeId:this.p1};else this.p1=i}if(typeof this.p2==="string"){if(!(i=this.model.nodeById(this.p2)))return{mid:"E_CSTR_NODE_NOT_EXISTS",id:this.id,loc:"end",p:"p2",nodeId:this.p2};else this.p2=i}if(mec.isEps(this.p1.x-this.p2.x)&&mec.isEps(this.p1.y-this.p2.y))s={mid:"W_CSTR_NODES_COINCIDE",id:this.id,p1:this.p1.id,p2:this.p2.id};if(!this.hasOwnProperty("ori"))this.ori={type:"free"};if(!this.hasOwnProperty("len"))this.len={type:"free"};if(typeof this.ori.ref==="string"){if(!(i=this.model.constraintById(this.ori.ref)))return{mid:"E_CSTR_REF_NOT_EXISTS",id:this.id,sub:"ori",ref:this.ori.ref};else this.ori.ref=i;if(this.ori.type==="drive"){if(this.ori.ref[this.ori.reftype||"ori"].type==="free")return{mid:"E_CSTR_DRIVEN_REF_TO_FREE",id:this.id,sub:"ori",ref:this.ori.ref.id,reftype:this.ori.reftype||"ori"};if(typeof this.ratio!==undefined&&this.ratio!==1)return{mid:"E_CSTR_RATIO_IGNORED",id:this.id,sub:"ori",ref:this.ori.ref.id,reftype:this.ori.reftype||"ori"}}}if(typeof this.len.ref==="string"){if(!(i=this.model.constraintById(this.len.ref)))return{mid:"E_CSTR_REF_NOT_EXISTS",id:this.id,sub:"len",ref:this.len.ref};else this.len.ref=i;if(this.len.type==="drive"){if(this.len.ref[this.len.reftype||"len"].type==="free")return{mid:"E_CSTR_DRIVEN_REF_TO_FREE",id:this.id,sub:"len",ref:this.len.ref.id,reftype:this.len.reftype||"len"};if(typeof this.ratio!==undefined&&this.ratio!==1)return{mid:"E_CSTR_RATIO_IGNORED",id:this.id,sub:"len",ref:this.ori.ref.id,reftype:this.ori.reftype||"len"}}}return s},init(t,i){this.model=t;if(!this.model.notifyValid(this.validate(i)))return;const s=this.ori,e=this.len;this._angle=0;if(s.type==="free")this.init_ori_free(s);else if(s.type==="const")this.init_ori_const(s);else if(s.type==="drive")this.init_ori_drive(s);if(e.type==="free")this.init_len_free(e);else if(e.type==="const")this.init_len_const(e);else if(e.type==="drive")this.init_len_drive(e);this.sw=Math.sin(this.w);this.cw=Math.cos(this.w);this.lambda_r=this.dlambda_r=0;this.lambda_w=this.dlambda_w=0},angle(t){return this._angle=mec.infAngle(this._angle,t)},reset(){this.r0=this.len.hasOwnProperty("r0")?this.len.r0:Math.hypot(this.ay,this.ax);this.w0=this.ori.hasOwnProperty("w0")?this.angle(this.ori.w0):this.angle(Math.atan2(this.ay,this.ax));this._angle=this.w0;this.lambda_r=this.dlambda_r=0;this.lambda_w=this.dlambda_w=0},get type(){const t=this.ori,i=this.len;return t.type==="free"&&i.type==="free"?"free":t.type==="free"&&i.type!=="free"?"rot":t.type!=="free"&&i.type==="free"?"tran":t.type!=="free"&&i.type!=="free"?"ctrl":"invalid"},get initialized(){return this.model!==undefined},get dof(){return(this.ori.type==="free"?1:0)+(this.len.type==="free"?1:0)},get forceAbs(){return-this.lambda_r},get moment(){return-this.lambda_w/this.r},hasActiveDrives(t){let i=this.ori,s=this.len;return i.type==="drive"&&(i.input||t<=i.t0+i.Dt*(i.bounce?2:1)*(i.repeat||1)+.5*this.model.timer.dt)||s.type==="drive"&&(s.input||t<=s.t0+s.Dt*(s.bounce?2:1)*(s.repeat||1)+.5*this.model.timer.dt)},dependsOn(t){return this.p1===t||this.p2===t||this.ori&&this.ori.ref===t||this.len&&this.len.ref===t},get ax(){return this.p2.x-this.p1.x},get ay(){return this.p2.y-this.p1.y},get axt(){return this.p2.xtcur-this.p1.xtcur},get ayt(){return this.p2.ytcur-this.p1.ytcur},get axtt(){return this.p2.xtt-this.p1.xtt},get aytt(){return this.p2.ytt-this.p1.ytt},get ori_C(){return this.ay*this.cw-this.ax*this.sw},get ori_Ct(){return this.ayt*this.cw-this.axt*this.sw-this.wt*this.r},get ori_mc(){const t=mec.toZero(this.p1.im+this.p2.im);return t?1/t:0},get len_C(){return this.ax*this.cw+this.ay*this.sw-this.r},get len_Ct(){return this.axt*this.cw+this.ayt*this.sw-this.rt},get len_mc(){let t=mec.toZero(this.p1.im+this.p2.im);return t?1/t:0},pre(t){let i=this.w;this.cw=Math.cos(i);this.sw=Math.sin(i);this.ori_impulse_vel(this.lambda_w*t);this.len_impulse_vel(this.lambda_r*t);this.dlambda_r=this.dlambda_w=0},post(t){this.lambda_w+=this.dlambda_w;this.ori_apply_Q(this.lambda_w);this.lambda_r+=this.dlambda_r;this.len_apply_Q(this.lambda_r)},posStep(){let t,i=this.w;this.cw=Math.cos(i);this.sw=Math.sin(i);return this.type==="free"?true:this.type==="rot"?this.len_pos():this.type==="tran"?this.ori_pos():this.type==="ctrl"?(t=this.ori_pos(),this.len_pos()&&t):false},velStep(t){let i;return this.type==="free"?true:this.type==="rot"?this.len_vel(t):this.type==="tran"?this.ori_vel(t):this.type==="ctrl"?(i=this.ori_vel(t),this.len_vel(t)&&i):false},ori_pos(){const t=this.ori_C,i=-this.ori_mc*t;this.ori_impulse_pos(i);if(this.ori.ref){const t=this.ori.ref;if(this.ori.reftype==="len")t.len_impulse_pos(-(this.ori.ratio||1)*i);else t.ori_impulse_pos(-(this.ori.ratio||1)*this.r/t.r*i)}return mec.isEps(t,mec.lenTol)},ori_vel(t){const i=this.ori_Ct,s=-this.ori_mc*i;this.ori_impulse_vel(s);this.dlambda_w+=s/t;if(this.ori.ref){const i=this.ori.ref,e=this.ori.ratio||1;if(this.ori.reftype==="len"){i.len_impulse_vel(-e*s);i.dlambda_r-=e*s/t}else{i.ori_impulse_vel(this.r/i.r*e*s);i.dlambda_w-=this.r/i.r*e*s/t}}return mec.isEps(i*t,mec.lenTol)},ori_impulse_pos(t){this.p1.x+=this.p1.im*this.sw*t;this.p1.y+=-this.p1.im*this.cw*t;this.p2.x+=-this.p2.im*this.sw*t;this.p2.y+=this.p2.im*this.cw*t},ori_impulse_vel(t){this.p1.dxt+=this.p1.im*this.sw*t;this.p1.dyt+=-this.p1.im*this.cw*t;this.p2.dxt+=-this.p2.im*this.sw*t;this.p2.dyt+=this.p2.im*this.cw*t},ori_apply_Q(t){this.p1.Qx+=this.sw*t;this.p1.Qy+=-this.cw*t;this.p2.Qx+=-this.sw*t;this.p2.Qy+=this.cw*t},len_pos(){const t=this.len_C,i=-this.len_mc*t;this.len_impulse_pos(i);if(this.len.ref){if(this.len.reftype==="ori")this.len.ref.ori_impulse_pos(-(this.len.ratio||1)*i);else this.len.ref.len_impulse_pos(-(this.len.ratio||1)*i)}return mec.isEps(t,mec.lenTol)},len_vel(t){const i=this.len_Ct,s=-this.len_mc*i;this.len_impulse_vel(s);this.dlambda_r+=s/t;if(this.len.ref){const i=this.len.ref,e=this.ori.ratio||1;if(this.len.reftype==="ori"){i.ori_impulse_vel(-e*s);i.dlambda_w-=e*s/t}else{i.len_impulse_vel(-e*s);i.dlambda_r-=e*s/t}}return mec.isEps(i*t,mec.lenTol)},len_impulse_pos(t){this.p1.x+=-this.p1.im*this.cw*t;this.p1.y+=-this.p1.im*this.sw*t;this.p2.x+=this.p2.im*this.cw*t;this.p2.y+=this.p2.im*this.sw*t},len_impulse_vel(t){this.p1.dxt+=-this.p1.im*this.cw*t;this.p1.dyt+=-this.p1.im*this.sw*t;this.p2.dxt+=this.p2.im*this.cw*t;this.p2.dyt+=this.p2.im*this.sw*t},len_apply_Q(t){this.p1.Qx+=-this.cw*t;this.p1.Qy+=-this.sw*t;this.p2.Qx+=this.cw*t;this.p2.Qy+=this.sw*t},init_ori_free(t){this.w0=this.angle(Math.atan2(this.ay,this.ax));mec.assignGetters(this,{w:()=>this.angle(Math.atan2(this.ay,this.ax)),wt:()=>(this.ayt*this.cw-this.axt*this.sw)/this.r,wtt:()=>(this.aytt*this.cw-this.axtt*this.sw)/this.r})},init_ori_const(t){this.w0=t.hasOwnProperty("w0")?t.w0:this.angle(Math.atan2(this.ay,this.ax));if(!!t.ref){const i=t.ref=this.model.constraintById(t.ref)||t.ref,s=t.reftype||"ori",e=t.ratio||1;if(!i.initialized)i.init(this.model);if(s==="ori")mec.assignGetters(this,{w:()=>this.w0+e*(i.w-i.w0),wt:()=>e*i.wt,wtt:()=>e*i.wtt,ori_C:()=>this.r*(this.angle(Math.atan2(this.ay,this.ax))-this.w0)-e*this.r*(i.angle(Math.atan2(i.ay,i.ax))-i.w0),ori_Ct:()=>this.ayt*this.cw-this.axt*this.sw-e*this.r/i.r*(i.ayt*i.cw-i.axt*i.sw),ori_mc:()=>{let t=mec.toZero(this.p1.im+this.p2.im)+e**2*this.r**2/i.r**2*mec.toZero(i.p1.im+i.p2.im);return t?1/t:0}});else{mec.assignGetters(this,{w:()=>this.w0+e*(i.r-i.r0)/this.r,wt:()=>e*i.rt,wtt:()=>e*i.rtt,ori_C:()=>this.r*(this.angle(Math.atan2(this.ay,this.ax))-this.w0)-e*(i.ax*i.cw+i.ay*i.sw-i.r0),ori_Ct:()=>this.ayt*this.cw-this.axt*this.sw-e*(i.axt*i.cw+i.ayt*i.sw),ori_mc:()=>{let t=mec.toZero(this.p1.im+this.p2.im)+e**2*mec.toZero(i.p1.im+i.p2.im);return t?1/t:0}})}}else{mec.assignGetters(this,{w:()=>this.w0,wt:()=>0,wtt:()=>0})}},init_ori_drive(t){this.w0=t.hasOwnProperty("w0")?t.w0:this.angle(Math.atan2(this.ay,this.ax));t.Dw=t.Dw||2*Math.PI;t.t0=t.t0||0;t.Dt=t.Dt||1;if(t.input){t.local_t=0;t.t=(()=>t.local_t);t.inputCallbk=(i=>{t.local_t=i*Math.PI/180*t.Dt/t.Dw})}else t.t=(()=>this.model.timer.t);t.drive=mec.drive.create({func:t.func||t.input&&"static"||"linear",z0:t.ref?0:this.w0,Dz:t.Dw,t0:t.t0,Dt:t.Dt,t:t.t,bounce:t.bounce,repeat:t.repeat});if(!!t.ref){const i=t.ref=this.model.constraintById(t.ref)||t.ref,s=t.reftype||"ori",e=t.ratio||1;if(!i.initialized)i.init(this.model);if(s==="ori")mec.assignGetters(this,{w:()=>this.w0+(i.w-i.w0)+t.drive.f(),wt:()=>i.wt+t.drive.ft(),wtt:()=>i.wtt+t.drive.ftt(),ori_C:()=>this.r*(this.angle(Math.atan2(this.ay,this.ax))-this.w0)-this.r*(i.angle(Math.atan2(i.ay,i.ax))-i.w0)-this.r*t.drive.f(),ori_Ct:()=>this.ayt*this.cw-this.axt*this.sw-this.r/i.r*(i.ayt*i.cw-i.axt*i.sw)-this.r*t.drive.ft(),ori_mc:()=>{let t=mec.toZero(this.p1.im+this.p2.im)+this.r**2/i.r**2*mec.toZero(i.p1.im+i.p2.im);return t?1/t:0}});else mec.assignGetters(this,{w:()=>this.w0+e*(i.r-i.r0)+t.drive.f(),wt:()=>e*i.rt+t.drive.ft(),wtt:()=>e*i.rtt+t.drive.ftt()})}else{mec.assignGetters(this,{w:t.drive.f,wt:t.drive.ft,wtt:t.drive.ftt})}},init_len_free(t){this.r0=Math.hypot(this.ay,this.ax);mec.assignGetters(this,{r:()=>this.ax*this.cw+this.ay*this.sw,rt:()=>this.axt*this.cw+this.ayt*this.sw,rtt:()=>this.axtt*this.cw+this.aytt*this.sw})},init_len_const(t){this.r0=t.hasOwnProperty("r0")?t.r0:Math.hypot(this.ay,this.ax);if(!!t.ref){const i=t.ref=this.model.constraintById(t.ref)||t.ref,s=t.reftype||"len",e=t.ratio||1;if(!i.initialized)i.init(this.model);if(s==="len")mec.assignGetters(this,{r:()=>this.r0+e*(i.r-i.r0),rt:()=>e*i.rt,rtt:()=>e*i.rtt,len_C:()=>this.ax*this.cw+this.ay*this.sw-this.r0-e*(i.ax*i.cw+i.ay*i.sw-i.r0),len_Ct:()=>this.axt*this.cw+this.ayt*this.sw-e*(i.axt*i.cw+i.ayt*i.sw),len_mc:()=>{let t=mec.toZero(this.p1.im+this.p2.im)+e**2*mec.toZero(i.p1.im+i.p2.im);return t?1/t:0}});else mec.assignGetters(this,{r:()=>this.r0+e*i.r*(i.w-i.w0),rt:()=>e*i.wt,rtt:()=>e*i.wtt,len_C:()=>this.ax*this.cw+this.ay*this.sw-this.r0-e*i.r*(i.angle(Math.atan2(i.ay,i.ax))-i.w0),len_Ct:()=>this.axt*this.cw+this.ayt*this.sw-e*(i.ayt*i.cw-i.axt*i.sw),len_mc:()=>{let t=mec.toZero(this.p1.im+this.p2.im)+e**2*mec.toZero(i.p1.im+i.p2.im);return t?1/t:0}})}else{mec.assignGetters(this,{r:()=>this.r0,rt:()=>0,rtt:()=>0})}},init_len_drive(t){this.r0=t.hasOwnProperty("r0")?t.r0:Math.hypot(this.ay,this.ax);t.Dr=t.Dr||100;t.t0=t.t0||0;t.Dt=t.Dt||1;if(t.input){t.local_t=0;t.t=(()=>t.local_t);t.inputCallbk=(i=>{t.local_t=i*t.Dt/t.Dr})}else t.t=(()=>this.model.timer.t);t.drive=mec.drive.create({func:t.func||t.input&&"static"||"linear",z0:this.r0,Dz:t.Dr,t0:t.t0,Dt:t.Dt,t:t.t,bounce:t.bounce,repeat:t.repeat});if(!!t.ref){const i=t.ref=this.model.constraintById(t.ref)||t.ref,s=t.reftype||"len",e=t.ratio||1;if(!i.initialized)i.init(this.model);if(s==="len")mec.assignGetters(this,{r:()=>this.r0+e*(i.r-i.r0)+t.drive.f(),rt:()=>i.rt+t.drive.ft(),rtt:()=>i.rtt+t.drive.ftt(),len_C:()=>this.ax*this.cw+this.ay*this.sw-this.r0-(i.ax*i.cw+i.ay*i.sw-i.r0)-t.drive.f(),len_Ct:()=>this.axt*this.cw+this.ayt*this.sw-(i.axt*i.cw+i.ayt*i.sw)-t.drive.ft(),len_mc:()=>{let t=mec.toZero(this.p1.im+this.p2.im)+mec.toZero(i.p1.im+i.p2.im);return t?1/t:0}});else mec.assignGetters(this,{r:()=>this.r0+e*(i.w-i.w0)+t.drive.f(),rt:()=>e*i.wt+t.drive.ft(),rtt:()=>e*i.wtt+t.drive.ftt()})}else{mec.assignGetters(this,{r:t.drive.f,rt:t.drive.ft,rtt:t.drive.ftt})}},asJSON(){let t='{ "id":"'+this.id+'","p1":"'+this.p1.id+'","p2":"'+this.p2.id+'"';if(this.len&&!(this.len.type==="free")){t+=(this.len.type==="const"?',"len":{ "type":"const"':"")+(this.len.type==="drive"?',"len":{ "type":"drive"':"")+(this.len.ref?',"ref":"'+this.len.ref.id+'"':"")+(this.len.reftype?',"reftype":"'+this.len.reftype+'"':"")+(this.len.r0&&this.len.r0>1e-4?',"r0":'+this.len.r0:"")+(this.len.ratio&&Math.abs(this.len.ratio-1)>1e-4?',"ratio":'+this.len.ratio:"")+(this.len.func?',"func":"'+this.len.func+'"':"")+(this.len.arg?',"arg":"'+this.len.arg+'"':"")+(this.len.t0&&this.len.t0>1e-4?',"t0":'+this.len.t0:"")+(this.len.Dt?this.len.repeat?',"Dt":'+this.len.Dt/this.len.repeat+',"repeat":'+this.len.repeat:',"Dt":'+this.len.Dt:"")+(this.len.Dr?',"Dr":'+this.len.Dr:"")+(this.len.bounce?',"bounce":true':"")+(this.len.input?',"input":true':"")+" }"}if(this.ori&&!(this.ori.type==="free")){t+=(this.ori.type==="const"?',"ori":{ "type":"const"':"")+(this.ori.type==="drive"?',"ori":{ "type":"drive"':"")+(this.ori.ref?',"ref":"'+this.ori.ref.id+'"':"")+(this.ori.reftype?',"reftype":"'+this.ori.reftype+'"':"")+(this.ori.w0&&this.ori.w0>1e-4?',"r0":'+this.ori.w0:"")+(this.ori.ratio&&Math.abs(this.ori.ratio-1)>1e-4?',"ratio":'+this.ori.ratio:"")+(this.ori.func?',"func":"'+this.ori.func+'"':"")+(this.ori.arg?',"arg":"'+this.ori.arg+'"':"")+(this.ori.t0&&this.ori.t0>1e-4?',"t0":'+this.ori.t0:"")+(this.ori.Dt?this.ori.repeat?',"Dt":'+this.ori.Dt/this.ori.repeat+',"repeat":'+this.ori.repeat:',"Dt":'+this.ori.Dt:"")+(this.ori.Dw?',"Dw":'+this.ori.Dw:"")+(this.ori.bounce?',"bounce":true':"")+(this.ori.input?',"input":true':"")+" }"}t+=" }";return t},get isSolid(){return false},get sh(){return this.state&g2.OVER?[0,0,10,mec.hoveredElmColor]:this.state&g2.EDIT?[0,0,10,mec.selectedElmColor]:false},hitContour({x:t,y:i,eps:s}){const e=this.p1,r=this.p2,h=this.p2.x-this.p1.x,n=this.p2.y-this.p1.y,o=2*mec.node.radius/Math.hypot(n,h);return g2.isPntOnLin({x:t,y:i},{x:e.x+o*h,y:e.y+o*n},{x:r.x-o*h,y:r.y-o*n},s)},get color(){return this.model.valid?mec.validConstraintColor:mec.invalidConstraintColor},g2(){let t=g2();if(this.model.graphics.linkage.constraints){const{p1:i,p2:s,w:e,r:r,type:h,ls:n,ls2:o,lw:a,id:l,idloc:d}=this;t.beg({x:i.x,y:i.y,w:e,scl:1,lw:2,ls:mec.constraintVectorColor,fs:"@ls",lc:"round",sh:()=>this.sh}).stroke({d:`M50,0 ${r},0`,ls:()=>this.color,lw:a+1,lsh:true}).drw({d:mec.constraint.arrow[h],lsh:true}).end();if(this.model.graphics.labels.constraints){let s=l||"?",r=Math.cos(e),h=Math.sin(e),n=d==="left"?.5:d==="right"?-.5:d+0===d?d:.5,o=Math.abs(n)*40,a=n>0?10:-15,p=i.x+o*r-a*h,f=i.y+o*h+a*r;if(this.ori.type==="ref"||this.len.type==="ref"){const t=this.ori.type==="ref"&&this.len.type==="ref"?",":"";s+="("+(this.ori.type==="ref"?this.ori.ref.id:"")+t+(this.len.type==="ref"?this.len.ref.id:"")+")";p-=3*h;f+=3*r}t.txt({str:s,x:p,y:f,thal:"center",tval:"middle",ls:mec.txtColor})}}return t}},arrow:{ctrl:"M0,0 35,0M45,0 36,-3 37,0 36,3 Z",rot:"M12,0 8,6 12,0 8,-6Z M0,0 8,0M15,0 35,0M45,0 36,-3 37,0 36,3 Z",tran:"M0,0 12,0M16,0 18,0M22,0 24,0 M28,0 35,0M45,0 36,-3 37,0 36,3 Z",free:"M12,0 8,6 12,0 8,-6ZM0,0 8,0M15,0 18,0M22,0 24,0 M28,0 35,0M45,0 36,-3 37,0 36,3 Z"}};
/**
 * mec.drive (c) 2018 Stefan Goessner
 * @license MIT License
 * @requires mec.core.js
 */
"use strict";mec.drive={create({func:t,z0:i,Dz:s,t0:e,Dt:r,t:h,bounce:n,repeat:o}){const a=(t,i,s)=>t>i&&t<=s;let l=t&&t in mec.drive?mec.drive[t]:mec.drive.linear;if(n){l=mec.drive.bounce(l);r*=2}if(o){l=mec.drive.bounce(l,o);r*=o}return{f:()=>i+l.f(Math.max(0,Math.min((h()-e)/r,1)))*s,ft:()=>a(h(),e,e+r)?l.fd((h()-e)/r)*s/r:0,ftt:()=>a(h(),e,e+r)?l.fdd((h()-e)/r)*s/r/r:0}},linear:{f:t=>t,fd:t=>1,fdd:t=>0},quadratic:{f:t=>t<=.5?2*t*t:-2*t*t+4*t-1,fd:t=>t<=.5?4*t:-4*t+4,fdd:t=>t<=.5?4:-4},harmonic:{f:t=>(1-Math.cos(Math.PI*t))/2,fd:t=>Math.PI/2*Math.sin(Math.PI*t),fdd:t=>Math.PI*Math.PI/2*Math.cos(Math.PI*t)},sinoid:{f:t=>t-Math.sin(2*Math.PI*t)/2/Math.PI,fd:t=>1-Math.cos(2*Math.PI*t),fdd:t=>Math.sin(2*Math.PI*t)*2*Math.PI},poly5:{f:t=>(10-15*t+6*t*t)*t*t*t,fd:t=>(30-60*t+30*t*t)*t*t,fdd:t=>(60-180*t+120*t*t)*t},static:{f:t=>t,fd:t=>0,fdd:t=>0},ramp(t){t=mec.clamp(t,0,.5);if(t===0)return mec.drive.linear;else if(t===.5)return mec.drive.quadratic;else{const i=1/((1-t)*t);return{f:function(s){return s<t?1/2*i*s*s:s<1-t?i*(s-1/2*t)*t:i*(1-3/2*t)*t+i*(s+t-1)*t-1/2*i*(s+t-1)*(s+t-1)},fd:function(s){return s<t?i*s:s<1-t?i*t:i*t-i*(s+t-1)},fdd:function(s){return s<t?i:s<1-t?0:-i}}}},bounce:function(t){if(typeof t==="string")t=mec.drive[t];return{f:i=>t.f(i<.5?2*i:2-2*i),fd:i=>t.fd(i<.5?2*i:2-2*i)*(i<.5?1:-1),fdd:i=>t.fdd(i<.5?2*i:2-2*i)*(i<.5?1:-1)}},repeat:function(t,i){if(typeof t==="string")t=mec.drive[t];return{f:s=>t.f(s*i%1),fd:s=>t.fd(s*i%1),fdd:s=>t.fdd(s*i%1)}},pot:[{f:t=>1,fd:t=>0,fdd:t=>0},{f:t=>t,fd:t=>1,fdd:t=>0},{f:t=>t*t,fd:t=>2*t,fdd:t=>2},{f:t=>t*t*t,fd:t=>3*t*t,fdd:t=>6*t},{f:t=>t*t*t*t,fd:t=>4*t*t*t,fdd:t=>12*t*t},{f:t=>t*t*t*t*t,fd:t=>5*t*t*t*t,fdd:t=>20*t*t*t}],inPot(t){return this.pot[t]},outPot(t){const i=this.pot[t];return{f:t=>1-i.f(1-t),fd:t=>i.fd(1-t),fdd:t=>-i.fdd(1-t)}},inOutPot(t){const i=this.pot[t],s=Math.pow(2,t-1);return{f:t=>t<.5?s*i.f(t):1-s*i.f(1-t),fd:t=>t<.5?s*i.fd(t):s*i.fd(1-t),fdd:e=>e<.5?s*(t-1)*i.fdd(e):-s*(t-1)*i.fdd(1-e)}},get inQuad(){return this.inPot(2)},get outQuad(){return this.outPot(2)},get inOutQuad(){return this.inOutPot(2)},get inCubic(){return this.inPot(3)},get outCubic(){return this.outPot(3)},get inOutCubic(){return this.inOutPot(3)},get inQuart(){return this.inPot(4)},get outQuart(){return this.outPot(4)},get inOutQuart(){return this.inOutPot(4)},get inQuint(){return this.inPot(5)},get outQuint(){return this.outPot(5)},get inOutQuint(){return this.inOutPot(5)}};
/**
