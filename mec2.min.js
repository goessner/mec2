 ...
 * @license MIT License
 */
"use strict";const mec={EPS:1.19209e-7,linTol:.001,angTol:2/180*Math.PI,velTol:.01,forceTol:.1,momentTol:.01,maxLinCorrect:20,asmItrMax:512,itrMax:256,corrMax:64,priority:"velocity",showNodeLabels:false,showConstraintLabels:true,showLoadLabels:true,validConstraintColor:"#777",invalidConstraintColor:"#b11",forceColor:"orange",gravity:{x:0,y:-10,active:false},m_u:.01,to_m(t){return t*mec.m_u},from_m(t){return t/mec.m_u},to_N(t){return t*mec.m_u},from_N(t){return t/mec.m_u},to_Nm(t){return t*mec.m_u*mec.m_u},from_Nm(t){return t/mec.m_u/mec.m_u},to_J(t){return mec.to_Nm(t)},from_J(t){return mec.from_Nm(t)},to_kgm2(t){return t*mec.m_u*mec.m_u},from_kgm2(t){return t/mec.m_u/mec.m_u},isEps(t,i){return t<(i||mec.EPS)&&t>-(i||mec.EPS)},toZero(t,i){return t<(i||mec.EPS)&&t>-(i||mec.EPS)?0:t},clamp(t,i,s){return Math.min(Math.max(t,i),s)},toRad(t){return t*Math.PI/180},toDeg(t){return t/Math.PI*180},mixin(t,...i){i.forEach(i=>{t=Object.defineProperties(t,Object.getOwnPropertyDescriptors(i))});return t}};
/**
